...
#define DEF_LINALG_FUNC(tDType, tNAryClass, fLapackFunc)                                                                                                                                                                                \
  static void _iter_##fLapackFunc(na_loop_t* const lp) {                                                                                                                                                                                \
    ...
    struct _gges_option_##fLapackFunc* opt = (struct _gges_option_##fLapackFunc*)(lp->opt_ptr);                                                                                                                                         \
    ...
    lapack_int i = LAPACKE_##fLapackFunc(                                                                                                                                                                                               \
      opt->matrix_layout, opt->jobvsl, opt->jobvsr, opt->sort, opt->select,                                                                                                                                                             \
      n, a, lda, b, ldb, &s, alpha_r, alpha_i, beta, vsl, ldvsl, vsr, ldvsr);                                                                                                                                                           \
    *sdim = (int)s;                                                                                                                                                                                                                     \
    *info = (int)i;                                                                                                                                                                                                                     \
  }                                                                                                                                                                                                                                     \
                                                                                                                                                                                                                                        \
  static VALUE _linalg_lapack_##fLapackFunc(int argc, VALUE* argv, VALUE self) {                                                                                                                                                        \
    ...
    ID kw_table[4] = { rb_intern("order"), rb_intern("jobvsl"), rb_intern("jobvsr"), rb_intern("sort") };                                                                                                                               \
    ...
    ndfunc_arg_out_t aout[7] = { { tNAryClass, 1, shape_alphar }, { tNAryClass, 1, shape_alphai }, { tNAryClass, 1, shape_beta }, { tNAryClass, 2, shape_vsl }, { tNAryClass, 2, shape_vsr }, { numo_cInt32, 0 }, { numo_cInt32, 0 } }; \
...
#define DEF_LINALG_FUNC_COMPLEX(tDType, tNAryClass, fLapackFunc)                                                                                                                                      \
  static void _iter_##fLapackFunc(na_loop_t* const lp) {                                                                                                                                              \
    ...
    lapack_int i = LAPACKE_##fLapackFunc(                                                                                                                                                             \
      opt->matrix_layout, opt->jobvsl, opt->jobvsr, opt->sort, opt->select,                                                                                                                           \
      n, a, lda, b, ldb, &s, alpha, beta, vsl, ldvsl, vsr, ldvsr);                                                                                                                                    \
    *sdim = (int)s;                                                                                                                                                                                   \
    *info = (int)i;                                                                                                                                                                                   \
  }                                                                                                                                                                                                   \
                                                                                                                                                                                                      \
  static VALUE _linalg_lapack_##fLapackFunc(int argc, VALUE* argv, VALUE self) {                                                                                                                      \
    ...
    size_t shape_vsr[2] = { n, jobvsr == 'N' ? 1 : n };                                                                                                                                               \
    ndfunc_arg_in_t ain[2] = { { OVERWRITE, 2 }, { OVERWRITE, 2 } };                                                                                                                                  \
    ndfunc_arg_out_t aout[6] = { { tNAryClass, 1, shape_alpha }, { tNAryClass, 1, shape_beta }, { tNAryClass, 2, shape_vsl }, { tNAryClass, 2, shape_vsr }, { numo_cInt32, 0 }, { numo_cInt32, 0 } }; \
